...
RUNTIME_SRC = PROJECT_ROOT / "pi18" / "runtime"
WEB_SRC = PROJECT_ROOT / "pi18" / "web"
SERVICE_TEMPLATE = PROJECT_ROOT / "pi18" / "templates" / "pi18-reader.service.tpl"

INSTALL_RUNTIME_DIR = Path("/home/pi/inverter-autosetup-test/pi18")
CONFIG_PATH = Path("/home/pi/inverter-autosetup-test/config_pi18_test.json")

def main() -> int:
    print("== PI18 Auto-Setup TESTMODUS ==")
    answers = collect_common_answers(default_name="WR2", default_ui_dir="/var/www/html/wr2test-auto-ui")
    ...
    save_json(CONFIG_PATH, {
        **answers,
        ...
        "service_name": "pi18-reader-test.service",
        "mode": "test",
    })
    ...
    service_text = render_template(template, {
        ...
        "service_description": "PI18 Reader TEST",
    })

    local_service_copy = PROJECT_ROOT / "build" / "pi18-reader-test.service"
